...
const EmailSent = () => {
    return (
        <div className="flex items-center justify-center min-h-screen p-4">
            <div className="bg-[#A40C0C] p-8 rounded-lg shadow-lg max-w-md w-full text-center">
                ...
                <h2 className="text-xl  font-bold mb-6 text-green-300">Password Reset Email Sent</h2>
